...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
            Examples:
            python reportr-client.py --progress-report
            python reportr-client.py --generate-readme
            python reportr-client.py --summarize-repo
        """
    )
...
def main():
    ...
    if not any([args.progress_report, args.generate_readme, args.summarize_repo, args.all]):
        parser = argparse.ArgumentParser(description="Reportr - AI-powered repository analysis and documentation tool")
        parser.print_help()
        return
